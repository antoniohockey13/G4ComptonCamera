...
void ComptCameraEventAction::EndOfEventAction(const G4Event* event)
{
        ...
        if (((*hit_collection_lgad)[i]->GetParticleID() == 22) & ((*hit_collection_lgad)[i]->GetDetectorNb() == 1))
        {
            for (size_t j = i; j < hit_collection_lgad->entries(); ++j)
            {
            ...
            
                {
                    ...
                    anManager->FillNtupleDColumn(0, 1, (*hit_collection_lgad)[i]->GetPos()[0]/mm);
                    anManager->FillNtupleDColumn(0, 2, (*hit_collection_lgad)[i]->GetPos()[1]/mm);
                    anManager->FillNtupleDColumn(0, 3, (*hit_collection_lgad)[i]->GetPos()[2]/mm);
                    anManager->FillNtupleDColumn(0, 4, (*hit_collection_lgad)[j]->GetPos()[0]/mm);
                    anManager->FillNtupleDColumn(0, 5, (*hit_collection_lgad)[j]->GetPos()[1]/mm);
                    anManager->FillNtupleDColumn(0, 6, (*hit_collection_lgad)[j]->GetPos()[2]/mm);
                    anManager->FillNtupleDColumn(0, 7, (*hit_collection_lgad)[i]->GetPreMom()[0]/keV);
                    anManager->FillNtupleDColumn(0, 8, (*hit_collection_lgad)[i]->GetPreMom()[1]/keV);
                    anManager->FillNtupleDColumn(0, 9, (*hit_collection_lgad)[i]->GetPreMom()[2]/keV);
                    anManager->FillNtupleDColumn(0, 10, (*hit_collection_lgad)[i]->GetPostMom()[0]/keV);
                    anManager->FillNtupleDColumn(0, 11, (*hit_collection_lgad)[i]->GetPostMom()[1]/keV);
                    anManager->FillNtupleDColumn(0, 12, (*hit_collection_lgad)[i]->GetPostMom()[2]/keV);
                    anManager->FillNtupleDColumn(0, 13, (*hit_collection_lgad)[i]->GetTime()/ps);
                    anManager->FillNtupleDColumn(0, 14, (*hit_collection_lgad)[j]->GetTime()/ps);
    ...
    for (size_t i = 0; i < hit_collection_lgad->entries(); ++i)
    {
        ...
        anManager->FillNtupleIColumn(1, 1, (*hit_collection_lgad)[i]->GetDetectorNb());
        anManager->FillNtupleDColumn(1, 2, (*hit_collection_lgad)[i]->GetPos()[0]/mm);
        anManager->FillNtupleDColumn(1, 3, (*hit_collection_lgad)[i]->GetPos()[1]/mm);
        anManager->FillNtupleDColumn(1, 4, (*hit_collection_lgad)[i]->GetPos()[2]/mm);
        anManager->FillNtupleDColumn(1, 5, (*hit_collection_lgad)[i]->GetPreMom()[0]/keV);
        anManager->FillNtupleDColumn(1, 6, (*hit_collection_lgad)[i]->GetPreMom()[1]/keV);
        anManager->FillNtupleDColumn(1, 7, (*hit_collection_lgad)[i]->GetPreMom()[2]/keV);
        anManager->FillNtupleDColumn(1, 8, (*hit_collection_lgad)[i]->GetPostMom()[0]/keV);
        anManager->FillNtupleDColumn(1, 9, (*hit_collection_lgad)[i]->GetPostMom()[1]/keV);
        anManager->FillNtupleDColumn(1, 10, (*hit_collection_lgad)[i]->GetPostMom()[2]/keV);
        anManager->FillNtupleDColumn(1, 11, (*hit_collection_lgad)[i]->GetEnergyLost()/keV);
        anManager->FillNtupleIColumn(1, 12, (*hit_collection_lgad)[i]->GetParticleID());
        anManager->FillNtupleIColumn(1, 13, (*hit_collection_lgad)[i]->GetTrackID());
        anManager->FillNtupleIColumn(1, 14, (*hit_collection_lgad)[i]->GetParentID());
        anManager->FillNtupleDColumn(1, 15, (*hit_collection_lgad)[i]->GetTime()/ps);
        anManager->FillNtupleDColumn(1, 16, (*hit_collection_lgad)[i]->GetPreKineticEnergy()/keV);
        anManager->FillNtupleDColumn(1, 17, (*hit_collection_lgad)[i]->GetPostKineticEnergy()/keV);
        anManager->FillNtupleSColumn(1, 18, (*hit_collection_lgad)[i]->GetProcessName());
        anManager->FillNtupleDColumn(1, 19, (*hit_collection_lgad)[i]->GetComptonAngle());
        anManager->FillNtupleDColumn(1, 20, (*hit_collection_lgad)[i]->GetStepLength()/mm);
